...
## 05 大纲 E2E 既有失败登记（2026-09-08 T12 全量 E2E 首跑发现）

| #   | 事项                              | 一句话说明                                                                                                                                            | 触发条件 / 建议归属                                                        |
| --- | --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| 1   | outline.e2e 全 3 用例失败（存量） | Ctrl+N 新标签未激活 / 条目跳转失焦 / 过滤空态缺失；已在分支基点 d47e21f 与 b4a01ed 双点复现，非 10 分支回归（本机 WebView2 已漂移至 152，疑环境相关） | 05 模块负责人按 bug 报告流程定位：先在既往绿环境复跑区分环境漂移与代码缺陷 |
